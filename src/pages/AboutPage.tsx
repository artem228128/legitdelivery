  ...
  return (
    <AboutContainer>
      <HeroSection>
        <HeroContent>
          <HeroText>
            ...
            <p>Робимо стиль доступним з 2022 року</p>
          </HeroText>
      ...
      <Section id="about-section">
        ...
        <AboutText>
          <p>
            Ми почали в 2022 році з простої ідеї — дати людям доступ до оригінальних, стильних кросівок без переплат.
          </p>
          <p>
            За цей час ми відправили більше 2000 пар клієнтам по всій Україні.
          </p>
          <p>
